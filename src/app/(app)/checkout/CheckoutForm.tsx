    ...
    <div className="md:px-7">
      <form className="text-title space-y-4">
        ...
        <div>
          ...
          <label className="text-[18px] mb-1 ml-2 text-title">E-mail me with news & offers</label>
        </div>

        {/* delivery */}
        <h2 className="font-semibold text-2xl">Delivery</h2>
        <div>
          <label className="text-[18px] block mb-1">Country Region</label>
          <select
            value={value}
            onChange={(e) => setValue(e.target.value)}
            className="border border-heading px-4 py-2 w-full rounded-sm outline-none"
          >
        ...
        <div>
          ...
          <label className="text-[18px] mb-1 ml-2 text-title">Save this information for the next time</label>
        </div>
      </form>
    </div>
  )
